...
class Membership(CRideModel):
    ...
    A membership is the table that hols the relationship between
    a user and a circle.
    """
    ...
    is_admin = models.BooleanField(
        'circle admin',
        default=False,
        help_text="Circle admins can update the circle's data and amanage its members."
    )
    ...
    def __str__(self):
        ...
        return f'@{self.user.username} at {self.cirlce.slug_name}'
